...
public class KneeProtection extends Equipment {
    ...
    private Long id;
    @javax.validation.constraints.Size(min = 3, max = 30, message = "{knee_protection.message.invalid_name}")
    private String name;
    ...
    public KneeProtection(String name, boolean available, EquipmentCondition condition, Size size) {
        this.name = name;
